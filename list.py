...
this_is_list = [1, "oke", 9.0, "oke"] #mutable
...
# print("Data from index 1 until 2 is ", this_is_list[1:3])
...
#pop vs remove
# pop ngambil berdasarkan index
#remove ngambil berdasarkan yang mau dihapus
#remove itu ga nge-return apa apa
...
#sort vs sorted
#sort ngembaliin apa apa, return None
#sorted bakal ke sort kalau dia diprint pake method shorted(list_kamu)
nums = [4, 1, 2, 3]
...
l = x.split() #default separator nya itu spasi
print(l)
print("###".join(l))
...
#Sudah berbeda reference jadi tidak ikut berubah
x = [3, 1]
